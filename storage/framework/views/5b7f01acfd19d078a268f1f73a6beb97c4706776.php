                    ...
                    <div class="panel panel-success ">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                <tr class="success">
                                    <th class="col-md-3">eingetragene Kurse</th>
                                    <th class="col-md-2">Rolle</th>
                                    <th class="col-md-3 text-center">Option</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a
                                                class="btn btn-primary btn-md col-md-11 col-md-offset-2 "
                                ...
                                <tr>
                                    ...
                                    <td>Student</td>
                                    <td class="text-center"><a
                                                class="btn btn-primary btn-md col-md-11 col-md-offset-2 b"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a
                                                class="btn btn-primary btn-md col-md-11 col-md-offset-1 b"
                                                href="<?php echo e(url('/abgabe')); ?>" role="button">Abgabenübersicht</a></td>
                                </tr>
                                </tbody>
                            </table>
