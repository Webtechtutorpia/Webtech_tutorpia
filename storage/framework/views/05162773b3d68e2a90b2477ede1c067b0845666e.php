<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="row">
            ...
            <?php endif; ?>
                <?php if( Session::has('negativ')): ?>
                    <p class="bg-danger"> <?php echo e(session()->pull('negativ')); ?></p>
                <?php endif; ?>
            <?php if(Auth::user()->rolle =='admin'): ?>
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body notVisible">
                        ...
                        <form method="post" action="<?php echo e(Url ('userchanges')); ?>">
                        ...
                        <br>
                        <form action=" <?php echo e(Url ('deleteUser')); ?>" method="post" onsubmit="if( document.getElementsByName('delete')[0].value != ''){return confirm('Sind Sie sicher, dass Sie den Account wirklich löschen wollen? An den Account gebundete Daten wie beispielweise geleitetete Kurse werden ebenfalls verloren gehen.')}">
                            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                ...
                <?php else: ?>
                    <form method="post" action="<?php echo e(URL ('belegungchanges')); ?>">
                        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                        ...
                        <?php $__currentLoopData = $kurse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kurs): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <div class="panel panel-success">
                                <div class="panel-heading panel" onclick="panel_behavior(this)"><?php echo e($kurs['kurs']); ?>
