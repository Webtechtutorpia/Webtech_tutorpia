        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body notVisible">
              <label>Rolle ändern</label>
                <form method="post" action="<?php echo e(Url ('userchanges')); ?>"  onsubmit="if( document.getElementsByName('delete')[0].value != ''){return confirm('Sind Sie sicher, dass Sie den Account wirklich löschen wollen? An den Account gebundete Daten wie beispielweise geleitetete Kurse werden ebenfalls verloren gehen.')}">
