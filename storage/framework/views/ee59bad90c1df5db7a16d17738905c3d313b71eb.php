                                ...
                                <table class="table-responsive">
                                    ...
                                    <tr>
                                        <?php if($value->zustand == '.'|| $value->zustand == '+' || $value->zustand == '-'): ?>
                                            <td class="col-md-4 col-xs-8"> <p><?php echo e(Carbon\Carbon::parse($value->abgabeupdated_at)->format('d-m-Y H:i:s')); ?></p></td>
                                        <?php endif; ?>
                                            <?php if($value->zustand == '.'): ?>
                                            <td class="col-md-4 col-xs-8"><p><?php echo e($value->erstellt_von); ?> hat <?php echo e($value->aufgabenname); ?> mit Abgabe am <?php echo e($value->abgabedatum); ?> im Kurs <?php echo e($value->kurs); ?> erstellt.</p>
                                            </td>
                                        <?php elseif($value->zustand == '+' || $value->zustand == '-'): ?>
                                        <td class="col-md-4 col-xs-8"><p><?php echo e($value->bearbeitet_von); ?> hat deine <?php echo e($value->aufgabenname); ?> im Kurs <?php echo e($value->kurs); ?> abgenommen.</p>
                                        </td>
                                        <?php endif; ?>
                                    </tr>
